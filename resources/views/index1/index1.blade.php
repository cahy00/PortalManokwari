    ...
    <section class="category-section">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header d-flex justify-content-between align-items-center mb-5">
          <h2>Pengumuman</h2>
          <div><a href="category.html" class="more">Lihat Semua Pengumuman</a></div>
        </div>
        ...
        <div class="row">
          <div class="col-md-9 order-md-2">
            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                <div class="post-entry-1">
                  <a href="single-post.html"><img src="{{asset('bkn/sample.jpg')}}" style="min-height: 415px; max-height:415px; min-width:610px;max-width:610px" alt="" class="img-fluid"></a>
                  <div class="post-meta"><span class="date">Business</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
